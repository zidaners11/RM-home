...
export async function getGlobalNexusStatus(homeData: any) {
  try {
    // Correct usage of API KEY from process.env and named parameter initialization
    ...
    // Using gemini-3-pro-preview for complex tasks with Google Search grounding
    ...
    // Extracting text and grounding chunks as per guidelines
    ...
    return { 
      text: "Protocolos de comunicación externa limitados. Sincronización en curso.",
      sources: [] 
    };
  }
}
